const fs = require('fs')
let buf = fs.readFileSync('C:\\Users\\xk\\Desktop\\GAMES101_Lecture_04.pdf')
// let buf = fs.readFileSync('C:\\Users\\xk\\Desktop\\sha1_122B.f3d')
// let buf = fs.readFileSync('C:\\Users\\xk\\Desktop\\sha1_96B.f3d')
// let buf = fs.readFileSync('C:\\Users\\xk\\Desktop\\sha1_64B.f3d')
// let buf = fs.readFileSync('C:\\Users\\xk\\Desktop\\a.txt')
...
// console.log(padBuf.slice(64 + 56), padBuf.length)
// <------------ groups -------------->
for (let i = 0; i < padBuf.length / 64; i++) {
    // console.log(H, padBuf.slice(i * 64, 64))
    oneTurn(padBuf.slice(i * 64, (i + 1) * 64))
}
// console.log(H[0].toString(16) + H[1].toString(16) + H[2].toString(16) + H[3].toString(16) + H[4].toString(16) === 'bf8b4530d8d246dd74ac53a13471bba17941dff7')
// console.log(H[0].toString(16) + H[1].toString(16) + H[2].toString(16) + H[3].toString(16) + H[4].toString(16), H[0].toString(16) + H[1].toString(16) + H[2].toString(16) + H[3].toString(16) + H[4].toString(16) === 'a0f44e44ce36989b4c7eea00e07f3bd62bcb2dcb')
// console.log(H[0].toString(16) + H[1].toString(16) + H[2].toString(16) + H[3].toString(16) + H[4].toString(16), H[0].toString(16) + H[1].toString(16) + H[2].toString(16) + H[3].toString(16) + H[4].toString(16) === '77ddc43ef24445eeaee182d3ece2aa671867720f')
// console.log(H[0].toString(16) + H[1].toString(16) + H[2].toString(16) + H[3].toString(16) + H[4].toString(16), H[0].toString(16) + H[1].toString(16) + H[2].toString(16) + H[3].toString(16) + H[4].toString(16) === '605914ff2ceeac3a189430524272ba1fb5536ece')
console.log(H[0].toString(16) + H[1].toString(16) + H[2].toString(16) + H[3].toString(16) + H[4].toString(16), H[0].toString(16) + H[1].toString(16) + H[2].toString(16) + H[3].toString(16) + H[4].toString(16) === 'b02972737633fb577df77de3e9b273edf8645702')
